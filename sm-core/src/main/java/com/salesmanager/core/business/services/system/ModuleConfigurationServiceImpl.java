...
@Slf4j
@Service
class ModuleConfigurationServiceImpl extends
        SalesManagerEntityServiceImpl<Long, IntegrationModule> implements
        ModuleConfigurationService {

    private final IntegrationModulesLoader integrationModulesLoader;
    ...
    public ModuleConfigurationServiceImpl(
            IntegrationModulesLoader integrationModulesLoader, ModuleConfigurationRepository moduleConfigurationRepository, CacheUtils cache) {
        super(moduleConfigurationRepository);
        this.integrationModulesLoader = integrationModulesLoader;
