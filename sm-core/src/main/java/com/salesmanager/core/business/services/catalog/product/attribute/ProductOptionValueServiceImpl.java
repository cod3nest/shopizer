...
@Service
class ProductOptionValueServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductOptionValue> implements ProductOptionValueService {

    private final ProductAttributeService productAttributeService;
    private final PageableProductOptionValueRepository pageableProductOptionValueRepository;
    private final ProductOptionValueRepository productOptionValueRepository;

    public ProductOptionValueServiceImpl(ProductAttributeService productAttributeService, PageableProductOptionValueRepository pageableProductOptionValueRepository, ProductOptionValueRepository productOptionValueRepository) {
