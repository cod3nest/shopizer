...
@Service
class ProductOptionServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductOption> implements ProductOptionService {

    private final ProductOptionRepository productOptionRepository;
    private final PageableProductOptionRepository pageableProductOptionRepository;
    private final ProductAttributeService productAttributeService;

    public ProductOptionServiceImpl(ProductOptionRepository productOptionRepository, PageableProductOptionRepository pageableProductOptionRepository, ProductAttributeService productAttributeService) {
