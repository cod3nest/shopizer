...
@Slf4j
@Service
class ManufacturerServiceImpl extends SalesManagerEntityServiceImpl<Long, Manufacturer> implements ManufacturerService {

    private final PageableManufacturerRepository pageableManufacturerRepository;
    private final ManufacturerRepository manufacturerRepository;

    public ManufacturerServiceImpl(PageableManufacturerRepository pageableManufacturerRepository, ManufacturerRepository manufacturerRepository) {
