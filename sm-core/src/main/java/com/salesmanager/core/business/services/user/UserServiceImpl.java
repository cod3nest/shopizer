...
@Service
class UserServiceImpl extends SalesManagerEntityServiceImpl<Long, User> implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, MerchantStoreService merchantStoreService, PageableUserRepository pageableUserRepository) {
