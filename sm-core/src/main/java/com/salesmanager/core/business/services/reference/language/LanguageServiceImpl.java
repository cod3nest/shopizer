...
@Slf4j
@Service
class LanguageServiceImpl extends SalesManagerEntityServiceImpl<Integer, Language> implements LanguageService {

    private final CacheUtils cache;
    private final LanguageRepository languageRepository;

    public LanguageServiceImpl(CacheUtils cache, LanguageRepository languageRepository) {
