...
public interface CustomerFacade {
    ...
    Customer getCustomerByUserName(final String userName, final MerchantStore store) throws Exception;
    ...
    void authenticate(Customer customer, String userName, String password) throws Exception;
