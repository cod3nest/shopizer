...
@Service
class TaxFacadeImpl implements TaxFacade {

    private final TaxClassService taxClassService;
    private final TaxRateService taxRateService;
    private final PersistableTaxClassMapper persistableTaxClassMapper;
    private final ReadableTaxClassMapper readableTaxClassMapper;
    private final PersistableTaxRateMapper persistableTaxRateMapper;
    private final ReadableTaxRateMapper readableTaxRateMapper;
